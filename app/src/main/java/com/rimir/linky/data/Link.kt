...
data class Link (
    ...
    @ColumnInfo(name = "created_time", defaultValue = "0") var createdTime : Long = System.currentTimeMillis(),
    @ColumnInfo(name = "updated_time", defaultValue = "0") var lastUpdatedTime : Long = -1,
