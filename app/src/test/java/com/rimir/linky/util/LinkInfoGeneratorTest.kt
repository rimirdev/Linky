...
import com.rimir.linky.data.LinkInfo
...
class LinkInfoGeneratorTest {
    ...
    fun githubRepository_return_correctInfo() {
        val url = "https://github.com/amrdeveloper/linky"
        val linkInfo = generateLinkInfo(url)
        val expectedInfo = LinkInfo("linky Repository", "linky Github Repository")
        assertThat(linkInfo).isEqualTo(expectedInfo)
    }

    @Test
    fun githubLink_return_correctInfo() {
        val url = "https://github.com/amrdeveloper/linky/readme.md"
        val linkInfo = generateLinkInfo(url)
